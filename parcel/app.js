...
init();
if (group1On) {animate(); console.log('group1 animated');}
if (group2On) {animate2(); console.log('group2 animated');}
if (group3On) {animate3(); console.log('group3 animated');}
if (group4On) {animate4(); console.log('group4 animated');}
